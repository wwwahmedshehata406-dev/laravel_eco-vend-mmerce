...
@section('contact')
  ...
  <div class="page" id="page-new-product">
    ...
    <div class="page-header" style="display:flex;align-items:flex-start;justify-content:space-between;flex-wrap:wrap;gap:12px;">
      <div>
        <div class="breadcrumb">Home <span>›</span> <span style="cursor:pointer;text-decoration:underline;" onclick="navigate('products',null)">Products</span> <span>›</span> New Product</div>
        <a href="{{ route('products.create') }}"> <h1 class="page-title">Add New Product</h1> </a>
        <p class="page-subtitle">Fill in the details to create a new product listing.</p>
      </div>
      <div style="display:flex;gap:8px;">
        <button class="btn btn-secondary" onclick="navigate('products',null)">Cancel</button>
          ...
          <div class="panel">
            ...
            <div class="panel-body">
              <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" id="prod-name" placeholder="e.g. Wireless Noise-Canceling Headphones"  />
              </div>
              <div class="form-group">
                <label class="form-label">Description *</label>
                <textarea class="form-control" name="description" id="prod-desc" rows="5" placeholder="Describe the product features, benefits, and specifications…"></textarea>
              </div>
            </div>
          </div>
            ...
            <div class="panel-body">
              <div class="grid-2">
                <div class="form-group">
                  ...
                  <input type="number" name="price" class="form-control" id="prod-price" placeholder="0.00" step="0.01" min="0"  />
                </div>
                <div class="form-group">
                  <label class="form-label">Sale Price ($)</label>
                  <input type="number" name="compare_price" class="form-control" id="prod-sale" placeholder="0.00" step="0.01" min="0" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="panel">
            ...
            <div class="panel-body">
              <div class="form-group">
                ...
                <input type="number" name="rating" class="form-control" id="prod-name" placeholder="e.g. Rating"  />
              </div>
            </div>
          </div>
