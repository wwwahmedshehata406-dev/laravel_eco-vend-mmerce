    ...
    <div class="page-header"
      ...
      <div>
        <div class="breadcrumb">Home <span>›</span> <span style="cursor:pointer;text-decoration:underline;"
            onclick="navigate('dashboard.products',null)">Products</span> <span>›</span> New Product</div>
    ...
    <div class="grid-2" style="align-items:start;">
          ...
          <div class="panel">
            ...
            <div class="panel-body">
              <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" id="prod-name"
                  placeholder="e.g. Wireless Noise-Canceling Headphones" />
              </div>
              <div class="form-group">
                <label class="form-label">Description *</label>
                <textarea class="form-control" name="description" id="prod-desc" rows="5"
            ...
            <div class="panel-body">
              <div class="grid-2">
                <div class="form-group">
                  ...
                  <input type="number" name="price" class="form-control" id="prod-price" placeholder="0.00" step="0.01"
                    min="0" />
                </div>
                <div class="form-group">
                  <label class="form-label">Sale Price ($)</label>
                  <input type="number" name="compare_price" class="form-control" id="prod-sale" placeholder="0.00"
                    step="0.01" min="0" />
                </div>
              </div>
            </div>
      ...
      <div style="display:flex;flex-direction:column;gap:16px;">
        ...
        <div class="panel">
          ...
          <div class="panel-body">
            <div class="upload-area" id="uploadArea" onclick="document.getElementById('imgInput').click()">
              ...
              <input type="file" name="image" id="imgInput" multiple accept="image/*" style="display:none;"
        ...
        <div style="display:flex;gap:8px;">
          ...
          <button class="btn btn-primary" style="flex:1;justify-content:center;" onclick="submitProductForm()">Publish
            Product</button>
        </div>
